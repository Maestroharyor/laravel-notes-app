...
<body class="font-sans antialiased dark:bg-black dark:text-white/50" :class="{ 'dark': darkMode }">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute -left-20 top-0 max-w-[877px] opacity-30"
            src="https://laravel.com/assets/img/welcome/background.svg" />
        <div
            class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid items-center grid-cols-2 gap-2 pt-8 lg:grid-cols-3">
                    ...
                    @if (Route::has('login'))
                        <nav class="flex items-center justify-end flex-1 gap-5 -mx-3">
                            @auth
                                <a href="{{ url('/dashboard') }}"
                                    class="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-brand-red dark:hover:bg-brand-red dark:focus:ring-brand-red">
                                    Dashboard
                                </a>
                            @else
                                <a href="{{ route('login') }}"
                    ...
                    <section class="">
                        <div class="grid max-w-screen-xl px-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12 ">
                            <div class="mr-auto place-self-center lg:col-span-7">
                                <h1
                                    class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl text-gray-950 dark:text-white">
                                    <span class="text-brand-red">Noteable</span> <br>Capture Your Thoughts, Organize
                                    Your Life
                                </h1>
                                <p
                                    class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                                    Whether you're brainstorming ideas, planning your day, or keeping track of important
                                    tasks, Notable makes it easy to stay organized and productive.</p>
                                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                                    <a href="{{ route('register') }}"
                                        class="inline-flex px-4 py-2 text-sm font-medium text-white rounded-lg bg-brand-red hover:bg-red-700 focus:ring-4 focus:ring-purple-300 lg:px-5 lg:py-3 ">
                            ...
                            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                                ...
                                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="737.38976"
                                    height="544" viewBox="0 0 737.38976 544"
                                    ...
                                    <path id="ea648e8d-1b31-4ae2-9566-f54bfd0d94c9-128" data-name="Path 411"
                                    ...
                                    <path id="b4f9d9e0-1a47-44a2-8a19-0d88a6e9c18f-129" data-name="Path 412"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="e168965a-63e1-4676-8cbb-3e09d33a4a3f-130" data-name="Path 413"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="af0ff97e-1a3a-4f6f-a511-2c807a938985-131" data-name="Path 414"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="e60f2d91-ad3b-421b-94cb-3aa0f5092f21-132" data-name="Path 415"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="a5554f8b-57e8-4c3b-815c-c76cc46b61b5-133" data-name="Path 416"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="eee68bf7-fbe9-4bfc-85ae-b0141fb14f45-134" data-name="Path 417"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="b9a7afa1-162f-46e2-88e2-f572ab59fc71-135" data-name="Path 418"
                                    ...
                                    <path
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ff2d20" />
                                    <polygon
                                    ...
                                    <path
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="eb40ba0f-f2ca-41e6-ba2e-bd824fb45cdc-136" data-name="Path 411"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="ea390b26-798a-41d7-8695-eb41cfeb13d4-137" data-name="Path 412"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="f9b4f79e-9356-48bc-89d8-91f80de67df3-138" data-name="Path 413"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="f3294a48-db04-45e1-afc8-dab6eb28e529-139" data-name="Path 414"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="bb6dba8b-bb0a-4f92-a6ea-c6252f741607-140" data-name="Path 415"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="b1d451cb-91ad-40cf-876e-6a74c98e5c4f-141" data-name="Path 416"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="bcef27e7-bcca-4cc4-a6d4-200e9e04132c-142" data-name="Path 417"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="ed29f808-f3a3-4ac8-bd45-563f73aa9d8b-143" data-name="Path 418"
                                    ...
                                    <path
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="ab56b95a-ad0a-4db6-b885-1de339e59248-144" data-name="Path 411"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="a65ba0e0-92d5-467b-b937-6962ba88422c-145" data-name="Path 412"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="fb801fe4-3edc-4e65-9957-dec023933e0a-146" data-name="Path 413"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="faab0864-6611-44c5-86ab-6dd51d336b1d-147" data-name="Path 413"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="ada3facf-2b93-40cb-83c6-b6d8dc380c35-148" data-name="Path 414"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="a50891a7-c495-4965-ab40-a1f907e5cce2-149" data-name="Path 415"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="f645be9d-0c31-4d92-bfb2-feede413f090-150" data-name="Path 416"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="f96ba49d-c571-4857-91da-e214cd5ba82f-151" data-name="Path 417"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="a7214c6f-9d52-425a-b9ef-635698aec079-152" data-name="Path 418"
                                ...
                                <a href="#" class="flex items-center lg:justify-center">
                                    <svg class="h-9 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 137 37"
                                        ...
                                        <path
                                            ...
                                            fill="currentColor" />
                                        <path d="M74.9258 25.0783H78.8688V10.9255H74.9258V25.0783Z"
                                            fill="currentColor" />
                                        <path
                ...
                <footer class="py-16 text-sm text-center text-black dark:text-white/70">
                    &copy; {{ date('Y') }} Noteable - Crafted by <a href="https://www.ayomideodewale.com"
                        target="_blank" class="underline dark:text-yellow-500 hover:text-yellow-600"> <span>Ayomide
                            Odewale</span></a>
                </footer>
            </div>
        </div>
